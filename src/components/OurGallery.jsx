...
const OurGallery = () => {
  return (
    <>
      <div id='gallery' className="px-4 py-10 sm:py-15 md:py-20 lg:py-25 relative">
        <img className='absolute right-0 max-sm:hidden pointer-events-none max-md:w-[100px] top-[-40px] md:-top-[64px]' src={pizzaSlice} alt="pizza-slice" />
          ...
          <div className="flex xl:flex-row flex-col justify-center mx-auto items-center gap-4 w-full pt-10">
            ...
            <div className="flex flex-col justify-center mx-auto gap-4 w-full max-w-[558px]">
              ...
              <div className="flex flex-col justify-center sm:flex-row max-sm:max-w-[558px] gap-4">
                ...
                <img src={GALLERY_DATA[5]} alt="Pizza with vegetables" className="object-cover pointer-events-none rounded-xl w-full max-sm:max-h-[329px] sm:max-w-[194px] lg:max-h-[235px]" />
              </div>
            </div>
