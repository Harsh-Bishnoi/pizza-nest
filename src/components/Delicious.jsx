...
const Delicious = () => {
    return (
        <>
            <div className="px-4 my-10 sm:my-15 md:my-20 lg:my-25">
                <div className="max-w-[1140px] mx-auto">
                    <div className="flex max-lg:flex-wrap gap-6 items-center">
                        {DELICIOUS_DATA.map((item, index) => (
                            <div data-aos="zoom-in" className="max-w-[700px] mx-auto lg:max-w-[558px] relative w-full min-h-[319px] pl-4 sm:pl-8 py-4 sm:py-[63px] rounded-xl bg-[url(../src/assets/images/png/delicious-bg-img.png)]" key={index}>
                                ...
                                <img className={`sm:absolute max-sm:ml-auto right-0 bottom-0 max-sm:max-w-[250px] w-full object-cover ${index === 1 ? "max-h-[161px] max-w-[330px]" : "max-w-[385px] max-h-[221px]"}`} src={item.img} alt="pizza-img" />
                                <div className="">
